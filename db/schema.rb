...
ActiveRecord::Schema.define(version: 2022_10_04_032447) do
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.integer "stock", default: 500, null: false
    t.integer "earning", default: 0, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "sale_areas", force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
